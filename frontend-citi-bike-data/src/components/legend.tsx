  ...
  return (
    <div className="ml-1 flex h-24 flex-row gap-1 font-sans tabular-nums">
      <div className="text-cb-white tabalur-nums border-cb-white/30 flex w-4 rounded-full border border-[0.5px] font-sans font-light tracking-wider backdrop-blur-sm">
        <div className="drop-shadow-cb-mini flex h-full w-full flex-col items-center justify-between rounded-full bg-gradient-to-t from-[#58A4CCa0] via-[#84649Ea0] to-[#7D0B0Da0] tabular-nums"></div>
      </div>
